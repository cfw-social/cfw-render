...
## Priority Order
1. **Check SFX library first** — `sfx/sfx-library.md` at `/Users/vasanth/ecosystem/harness/skills/sfx/`. Preview: `afplay /Users/vasanth/ecosystem/harness/skills/sfx/{category}/{file}.mp3`.
...
```
/Users/vasanth/ecosystem/harness/skills/sfx/: whoosh/ ding/ transition/ tension/ swell/ ambient/
```
Check `sfx-library.md` before generating. New SFX → `/Users/vasanth/ecosystem/harness/skills/sfx/{category}/` (NEVER in production `audio/`).

## Output Paths

- Voiceover: `{production}/interim/audio/{name}.mp3`
- SFX: `/Users/vasanth/ecosystem/harness/skills/sfx/{category}/{name}.mp3`
